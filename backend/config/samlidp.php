...
return [
    ...
    // 'certname'          => 'cert.pem', // unused
    // Name of the certificate key PEM file
    // 'keyname'           => 'key.pem', // unused
    ...
    'encrypt_assertion' => true, // <-- default
    //         'encrypt_assertion' => false,


    // Make sure messages are signed
    'messages_signed'   => true, // default : true

    // Defind what digital algorithm you want to use
    'digest_algorithm'  => \RobRichards\XMLSecLibs\XMLSecurityDSig::SHA1, // < -- default
