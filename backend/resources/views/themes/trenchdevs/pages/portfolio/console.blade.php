...
<head>
    ...
    <script nonce="{{ csp_nonce() }}"src="https://cdn.jsdelivr.net/npm/feather-icons/dist/feather.min.js"></script>
...
<div class="container-fluid p-5 pt-0">
    ...
    <nav>
        <ul class="mt-3 list-unstyled d-flex justify-content-center flex-wrap">
            ...
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="{{site_route('public.blogs')}}?username={{$user->username}}">
                    Blogs
                </a>
            </li>
        ...
        <nav class="col-md-6">
            <ul class="mt-3 list-unstyled ">
                ...
                <li class="nav-item"><a class=" js-scroll-trigger"
                                        href="{{site_route('public.blogs')}}?username={{$user->username}}">Blogs</a></li>
